...
public:
                       ...
                       HTTPServerResponse &response)
    {
        ...
        try
        {
            // std::cout << "form has last_name: " << form.has("last_name") << std::endl;
            // std::cout << "form has fisrt_name: " << form.has("fisrt_name") << std::endl;
            // std::cout << "form has login: " << form.has("login") << std::endl;
            // std::cout << "formMethod: " << request.getMethod() << std::endl;
